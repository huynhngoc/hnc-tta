...
#SBATCH --output=outputs/num_tta_analysis-%A-%a.out
#SBATCH --error=outputs/num_tta_analysis-%A-%a.out
...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys.sif python -u num_tta_analysis.py $1 $PROJECTS/ngoc/TTA 
