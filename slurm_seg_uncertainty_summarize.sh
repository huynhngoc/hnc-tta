...
#SBATCH --mail-user=aninel@nmbu.no # Email me when job is done.
...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys.sif python -u run_uncertainty_summarize.py $1 --iter $SLURM_ARRAY_TASK_ID $PROJECTS/ngoc/TTA
