...
#SBATCH --output=outputs/model_details-%A-%a.out
#SBATCH --error=outputs/model_details-%A-%a.out
...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys.sif python -u print_model_details.py $PROJECTS/ngoc/TTA
