...
if group1_threshold_index is not None:
    ax1.axvline(x=num_tta_cols[group1_threshold_index], color='red', linestyle='--', label=f'Threshold = {threshold}')
...
if group2_threshold_index is not None:
    ax2.axvline(x=num_tta_cols[group2_threshold_index], color='red', linestyle='--', label=f'Threshold = {threshold}')
...
# Add vertical line for group 1
if group1_threshold_index is not None:
    ax1.axvline(x=num_tta_cols[group1_threshold_index], color='red', linestyle='--', label='Threshold')
...
# Add vertical line for group 2
if group2_threshold_index is not None:
    ax2.axvline(x=num_tta_cols[group2_threshold_index], color='red', linestyle='--', label='Threshold')
