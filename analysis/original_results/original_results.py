...
print(f"OUS DSC mean: {ous_dsc_mean:.3f} ± {ous_dsc_std:.3f} (median: {ous_dsc_median:.3f})")
print(f"MAASTRO DSC mean: {maastro_dsc_mean:.3f} ± {maastro_dsc_std:.3f} (median: {maastro_dsc_median:.3f})")