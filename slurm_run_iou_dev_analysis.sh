...
#SBATCH --output=outputs/iou_dev-%A-%a.out
#SBATCH --error=outputs/iou_dev-%A-%a.out
...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys.sif python -u run_iou_dev_analysis.py $1 $2 $PROJECTS/ngoc/TTA 
