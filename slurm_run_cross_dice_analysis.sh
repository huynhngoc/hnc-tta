...
#SBATCH --error=outputs/cross_dice-%A-%a.out
...
rm -rf $TMPDIR/ray/*
singularity exec --nv deoxys.sif python -u run_avg_cross_dice_analysis.py $1 $PROJECTS/ngoc/TTA --num_tta $SLURM_ARRAY_TASK_ID
